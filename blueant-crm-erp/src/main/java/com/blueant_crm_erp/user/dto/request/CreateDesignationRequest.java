 ...
 * =============================================================================
 *
 * Request DTO used to create a new Designation.
 *
...
@NoArgsConstructor
@AllArgsConstructor
public class CreateDesignationRequest implements Serializable {
    ...
    @Min(
            value = 1,
            message = "Hierarchy level must be greater than zero."
    )
    @Max(
            value = 100,
            message = "Hierarchy level must not exceed 100."
    )
