...
import com.blueant_crm_erp.exception.common.RedisUnavailableException;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    log.error("Failed to release lock for key: {} from Redis", lockKey, e);
                }
            }
        } catch (org.springframework.dao.DataAccessException e) {
            log.error("Redis is unavailable during forgot password request processing for: {}", employeeCode, e);
            throw new RedisUnavailableException("Service is temporarily unavailable. Please try again later.", e);
        }
    }
