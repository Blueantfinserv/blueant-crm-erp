...
public class LeadDetailResponse {
     ...
     * Meeting History
     */
    private com.blueant_crm_erp.meeting.dto.response.MeetingSummaryResponse currentActiveMeeting;
    private java.util.List<com.blueant_crm_erp.meeting.dto.response.MeetingSummaryResponse> meetingHistory;
