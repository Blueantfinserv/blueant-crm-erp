...
/**
 * =============================================================================
 * Change Team Status Request
 * =============================================================================
 *
 * Request DTO used to activate or deactivate an existing Team.
 *
 * Responsibilities
 * -----------------------------------------------------------------------------
 * • Activate Team
...
@NoArgsConstructor
@AllArgsConstructor
public class ChangeTeamStatusRequest implements Serializable {
    ...
    /**
     * Reason for changing Team status.
     */
